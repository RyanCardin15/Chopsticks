/**
 * <h1> TwoPLayers </h1>
 * The TwoPlayers class is a child controller class extended from the Chopsticks class. This class is the
 * controller class to the TwoPlayers.fxml which handles all the buttons events that are in this game mode.
 * This is the TRADITIONAL game mode which the player chooses to in the starting menu.
...
public class TwoPlayers extends Chopsticks {
    ...
    public void btnHitLeft_click(){
        ...
        if ((turn%2)==0) { //player 2's turn
            if (topL.isSelected() && !topR.isSelected()) {      //if player 2 pick left hand to hit
            ...
            else if (topR.isSelected() && !topL.isSelected()) { //if player 2 pick right hand to hit
            ...
            else if (topL.isSelected() && topR.isSelected()) {  //if player 2 pick both hands to hit
