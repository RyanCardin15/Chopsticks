/**
 * <h1> SinglePLayer </h1>
 * The SinglePlayer class is a child controller class extended from the Chopsticks class. This class is the
 * controller class to the SinglePlayer.fxml which handles all the buttons events that are in this game mode.
